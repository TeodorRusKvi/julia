...
function init_servers(num_servers::Int, max_capacity::Int, max_queue_length::Int)
    return [Server(i, 0, 0, max_capacity, max_queue_length) for i in 1:num_servers]
end
...
function simulate_queue(arrivals::Vector{Float64}, service_times::Vector{Float64}, num_servers::Int, max_capacity::Int, max_queue_length::Int, verbose::Bool=false)
